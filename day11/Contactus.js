...
class Contactus extends Component{
    ...
    render(){
        return(<div className="contact-form">
            ...
            <input className="input" type="text" ref={this.name}></input><br></br>
            </div>
            <div className="input-container">
            <label>MobileNo:</label><br></br>
            <input className="input" type="text" ref={this.mobileno}></input><br></br>
            </div>
            <div className="input-container">
            <label>Message:</label><br></br>
            <textarea className="textarea" type="text" ref={this.message}></textarea><br></br><br></br>
            </div>
